...
11. The repository bundles the pre-verified default fonts in `fonts/local/` for personal usage. Custom project-specific fonts may be mapped via `fonts/font-map.json`.
